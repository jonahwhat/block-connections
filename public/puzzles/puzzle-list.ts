...
export const puzzleList: { [id: string]: Category[] } = {
  ...
  "012": [
    {
      ...
      items: ["STEAK", "BREAD", "CHORUS FRUIT", "PUMPKIN PIE"],
      level: 1,
    },
    {
      category: "BLOCKS THAT CAN GIVE OFF A REDSTONE SIGNAL",
      items: ["REDSTONE TORCH", "LEVER", "BLOCK OF REDSTONE", "DAYLIGHT DETECTOR"],
      level: 2,
    },
    {
      category: "CRAFTED WITH WAX",
      items: ["BEEHIVE", "CANDLE", "HONEYCOMB BLOCK", "WAXED BLOCK OF COPPER"],
      level: 3,
    },
    {
      category: "CAN BE USED TO PREVENT FALL DAMAGE",
